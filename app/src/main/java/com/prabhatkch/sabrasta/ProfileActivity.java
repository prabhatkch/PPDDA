...
// Highlight the current item (you are on "you" page)
...
// Set navigation item selection listener
        bottomNavigationView.setOnItemSelectedListener(new NavigationBarView.OnItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.you) {
                    // Already on this page, do nothing or show a toast
                    return true;
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(ProfileActivity.this, com.prabhatkch.sabrasta.LoginActivity.class));
            }
        });
    ...
    private void showUserProfile(FirebaseUser firebaseUser) {
        ...
        databaseReference.child(userID).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                com.prabhatkch.sabrasta.User user = snapshot.getValue(com.prabhatkch.sabrasta.User.class);
                if (user != null) {
                    fullname = user.name;
